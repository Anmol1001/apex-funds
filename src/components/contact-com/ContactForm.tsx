                    ...
                    <div className='row100 relative w-full'>
                        <div className='col relative w-full py-0 px-3 mt-7 mr-0 mb-3 duration-500'>
                            <div className='inputBox relative w-full h-10 text-eastern-blue-700'>
                                <input className='absolute w-full h-full bg-transparent shadow-none outline-none text-xl py-0 px-3 z-10 text-eastern-blue-700' type="text" name='' required/>
                                ...
                                <span className='line absolute bottom-0 block w-full h-0.5 bg-eastern-blue-700 duration-500 rounded-sm pointer-events-none'></span>
                            </div>
                        </div>
                        <div className='col relative w-full py-0 px-3 mt-7 mr-0 mb-3 duration-500'>
                            <div className='inputBox relative w-full h-10 text-eastern-blue-700'>
                    ...
                    <div className='row100 relative w-full'>
                        <div className='col relative w-full py-0 px-3 mt-7 mr-0 mb-3 duration-500'>
                            <div className='inputBox textarea relative w-full h-24 py-3 px-0 text-eastern-blue-700'>
                                <textarea name="message" className='h-full resize-none absolute w-full bg-transparent shadow-none outline-none text-xl py-1 px-3 z-10 text-eastern-blue-700' required></textarea>
