    ...
    return(
        <>
            <section id="whatwedo" className="p-8">
                ...
                <div className="flex flex-row flex-wrap justify-around h-[100vh] mt-20">
                    
                    <div className="flex flex-col flex-wrap w-1/2 justify-evenly">
                    ...
                    <div className="h-full max-w-1/2">
                        <Image src={nimesh2} alt="what we do image" className="w-full h-full"/>
                    </div>
                </div>
            </section>
        </>
